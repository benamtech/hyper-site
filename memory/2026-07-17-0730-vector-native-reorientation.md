...
refs[13]{file,role}:
  ...
  docs/architecture/18-vector-node-path-web-framework-model.md,"three-plane conceptual model"
  docs/research/19-vector-native-corrections-and-csi-validation.md,"academic + validate/pass/fail authority"
